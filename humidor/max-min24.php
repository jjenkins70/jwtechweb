...
<div class="container">
  <div class="row">
  <h3>MAX / MIN values Temperature and Humidity - Past 24 hours</h3>
  </div>
...
<?php
   ...
   $sql = "SELECT convert_tz(date,'UTC','EST') as date, MAX(format(temp,2)), MAX(format(hum,2)) FROM TempHumid order by date desc LIMIT 144";
